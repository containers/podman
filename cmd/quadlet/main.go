...
func generateUnitsInfoMap(units []*parser.UnitFile) map[string]*quadlet.UnitInfo {
	...
	for _, unit := range units {
		...
		case strings.HasSuffix(unit.Filename, ".volume"), strings.HasSuffix(unit.Filename, ".kube"):
			resourceName = ""
		case strings.HasSuffix(unit.Filename, ".network"), strings.HasSuffix(unit.Filename, ".image"):
			resourceName = ""
		default:
