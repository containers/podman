...
func init() {
	...
	flags.StringArrayVar(&addOpts.AnnotaionsCLI, annotationFlagName, nil, "set an `annotation` for the specified files of artifact")
...
func add(cmd *cobra.Command, args []string) error {
	...
	annots, err := utils.ParseAnnotations(addOpts.AnnotaionsCLI)
	if err != nil {
		return err
	}
