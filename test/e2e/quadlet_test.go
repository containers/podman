...
func loadQuadletTestcase(path, serviceName string) *quadletTestcase {
...
var _ = Describe("quadlet system generator", func() {
	var (
		...
		runQuadletTestCase = func(fileName string, exitCode int, errString string, serviceName string) {
			testcase := loadQuadletTestcase(filepath.Join("quadlet", fileName), serviceName)
