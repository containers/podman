...
func makeRuntime(ctx context.Context, runtime *Runtime) (err error) {
	...
	// Set up the state.
	//
	// TODO - if further break out the state implementation into libpod/state,
	// the config could take care of the code below.  It would further allow
	// to move the types and consts into a coherent package.
