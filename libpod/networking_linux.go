...
func (r *Runtime) teardownNetNS(ctr *Container) error {
	...
	if ctr.state.NetNS == nil {
		return fmt.Errorf("container %s has no network namespace", ctr.ID())
	}
...
// NOTE: This function is defined in networking_common.go - removed duplicate
