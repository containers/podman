...
[//]: # (BEGIN included file options/created-annotation.md)
#### **--created-annotation**
...
[//]: # (END   included file options/created-annotation.md)
...
[//]: # (BEGIN included file options/inherit-annotations.md)
...
[//]: # (END   included file options/inherit-annotations.md)
...
[//]: # (BEGIN included file options/rewrite-timestamp.md)
#### **--rewrite-timestamp**
...
[//]: # (END   included file options/rewrite-timestamp.md)
...
[//]: # (BEGIN included file options/source-date-epoch.md)
...
[//]: # (END   included file options/source-date-epoch.md)
