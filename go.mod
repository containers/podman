...
replace go.podman.io/storage => github.com/Luap99/container-libs/storage v0.0.0-20251110184829-be4222769451

replace go.podman.io/image/v5 => github.com/Luap99/container-libs/image/v5 v5.0.0-20251110184829-be4222769451

replace go.podman.io/common => github.com/Luap99/container-libs/common v0.0.0-20251110184829-be4222769451
