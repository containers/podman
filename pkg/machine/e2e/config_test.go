...
func (m *machineTestBuilder) setStdin(data *bytes.Buffer) *machineTestBuilder {
	m.stdin = data
	return m
}
...
func runWrapper(podmanBinary string, cmdArgs []string, stdinData *bytes.Buffer, timeout time.Duration, wait bool) (*machineSession, error) {
