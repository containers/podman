...
func TestCreatePodSystemdUnit(t *testing.T) {
	defaultHeaderInfo := `# pod-123abc.service
# autogenerated by Podman CI
`
	customizedHeaderInfo := `# Bar
`
	endHeaderInfo := `
`
	podContent := `[Unit]
...
`
	podGood := defaultHeaderInfo + endHeaderInfo + podContent
	podGoodNoHeaderInfo := podContent
	podGoodCustomizedHeaderInfo := defaultHeaderInfo + customizedHeaderInfo + endHeaderInfo + podContent
