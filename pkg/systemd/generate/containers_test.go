...
func TestCreateContainerSystemdUnit(t *testing.T) {
	defaultHeaderInfo := `# container-639c53578af4d84b8800b4635fa4e680ee80fd67e0e6a2d4eea48d1e3230f401.service
# autogenerated by Podman CI
`
	customizedHeaderInfo := `# Foo
`
	endHeaderInfo := `
`
	goodIDContent := `[Unit]
...
`
	goodID := defaultHeaderInfo + endHeaderInfo + goodIDContent
	goodIDNoHeaderInfo := goodIDContent
	goodIDCustomizedHeaderInfo := defaultHeaderInfo + customizedHeaderInfo + endHeaderInfo + goodIDContent
