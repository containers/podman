...
// UInt64OrMinusOne is a small helper that unmarshals JSON numbers and allows -1,
// mapping it to uint64 max to represent "unlimited" for rlimits.
...
func (x *UInt64OrMinusOne) UnmarshalJSON(b []byte) error {
	...
	if i, err := n.Int64(); err == nil {
		if i < -1 {
			return fmt.Errorf("invalid negative value for UInt64OrMinusOne: %d", i)
		}
		if i == -1 {
