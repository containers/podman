...
* Remote client remote of OCI artifacts and its RESTFUL API
...
This section is a historical account of what features were prioritized by quarter.  Results of the prioritization will be added prior to the start of each quarter (Jan, Apr, July, Oct).
